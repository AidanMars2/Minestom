...
public class PaletteTest {
    ...
    public void dimension() {
        assertThrows(Exception.class, () -> Palette.empty(-4, 3, 5, 1 << 15));
        assertThrows(Exception.class, () -> Palette.empty(0, 3, 5, 1 << 15));
        assertThrows(Exception.class, () -> Palette.empty(1, 3, 5, 1 << 15));
        assertDoesNotThrow(           () -> Palette.empty(2, 3, 5, 1 << 15));
        assertThrows(Exception.class, () -> Palette.empty(3, 3, 5, 1 << 15));
        assertDoesNotThrow(           () -> Palette.empty(4, 3, 5, 1 << 15));
        assertThrows(Exception.class, () -> Palette.empty(6, 3, 5, 1 << 15));
        assertDoesNotThrow(           () -> Palette.empty(16, 3, 5, 1 << 15));
    }

    @Test
    public void bitsPerEntry() {
        assertThrows(Exception.class, () -> Palette.empty(4, -1, 3, 1 << 8));
        assertThrows(Exception.class, () -> Palette.empty(4, 0, 3, 1 << 8));
        assertDoesNotThrow(           () -> Palette.empty(4, 1, 3, 1 << 8));
        assertThrows(Exception.class, () -> Palette.empty(4, 1, 1, 1 << 8));
        assertThrows(Exception.class, () -> Palette.empty(4, 2, 1, 1 << 8));
        assertThrows(Exception.class, () -> Palette.empty(4, 1, 3, 1 << 1));
        assertThrows(Exception.class, () -> Palette.empty(4, 1, 3, 1 << 2));
    }
    ...
    public void placementHighValue() {
        ...
        final Palette palette = Palette.empty(16, 1, 3, 1 << 8);
        // Indirect
        for (int i = 0; i < 4; i++) palette.set(0, 0, i, value + i);
        for (int i = 0; i < 4; i++) assertEquals(value + i, palette.get(0, 0, i));
        assertEquals(3, palette.bitsPerEntry());
        // Direct
        for (int i = 0; i < 16; i++) palette.set(0, 0, i, value + i);
        for (int i = 0; i < 16; i++) assertEquals(value + i, palette.get(0, 0, i));
        assertEquals(17, palette.bitsPerEntry());
    }
    ...
    @Test
    public void resize() {
        Palette palette = Palette.sized(16, 1, 5, 1 << 15, 2);
        palette.set(0, 0, 0, 1);
    ...
    public void replaceLoop() {
        var palette = Palette.sized(2, 1, 8, 1 << 15, 4);
    ...
    public void loadCount() {
        Palette testPalette = Palette.empty(4, 4, 8, 1 << 12);
